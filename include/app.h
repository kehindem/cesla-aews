...
#define BBCLK_DIVIDER_VALUE             BBCLK_DIVIDER_8
	...
	#define SLOWCLK_PRESCALE_VALUE          SLOWCLK_PRESCALE_4 			/* 2MHz */
#elif RTE_APP_ADC_SAMPLING_RATE == 1									/* 12.5kHz */
	#define SLOWCLK_PRESCALE_VALUE          SLOWCLK_PRESCALE_4 			/* 2MHz */
#elif RTE_APP_ADC_SAMPLING_RATE == 2									/* 25kHz */
	#define SLOWCLK_PRESCALE_VALUE          SLOWCLK_PRESCALE_2 			/* 4MHz */
#elif RTE_APP_ADC_SAMPLING_RATE == 3									/* 50kHz */
	#define SLOWCLK_PRESCALE_VALUE          SLOWCLK_PRESCALE_1 			/* 8MHz */
#endif
